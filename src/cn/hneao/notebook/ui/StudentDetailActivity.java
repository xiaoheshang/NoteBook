...
import cn.hneao.notebook.widget.ScrollViewWithPinnedView;
...
public class StudentDetailActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((ScrollViewWithPinnedView) findViewById(R.id.main_scroll))
				.setPinnedView(this.findViewById(R.id.pinned));
	}
